...
#define SILENCE_FALLTHRU_WARNING
#if defined __has_attribute
#  if __has_attribute(__fallthrough__)
#    undef SILENCE_FALLTHRU_WARNING
#    define SILENCE_FALLTHRU_WARNING __attribute__((__fallthrough__))
#  endif
#endif
...
#if !defined(HAVE_ASM_ENCRYPT_DECRYPT)      // assembler version of encrypt+decrypt
#undef  r
#define r   r0
...
#endif
#endif      // assembler version of encrypt+decrypt
